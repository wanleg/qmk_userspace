...
[_FN] = LAYOUT_ortho_4x12_wrapper(
  QK_BOOT,   _______________Gherkin_FN_0________________, _______,
  OUT_BT,  _______________Gherkin_FN_1________________, _______,
  OUT_USB, _______________Gherkin_FN_2________________, _______,
  KC_NUM, _______, _______, GHERKIN, _______, _______, _______, _______, _______, _______, _______, _______
),
#else
[_FN] = LAYOUT_ortho_4x12_wrapper(
  QK_BOOT,   _______________Gherkin_FN_0________________, _______,
