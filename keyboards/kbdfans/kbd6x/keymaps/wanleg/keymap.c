...
_______, _______________Gherkin_DIR_2_______________, _______, QK_BOOT,
...
_______, BL_BRTG, BL_DOWN, BL_UP,   BL_TOGG, BL_STEP,  BL_ON,   _______, _______, _______, _______, _______, _______, _______,
...
_______, _______, _______,                   _______,                    QWERTY,  gGHERKIN, KC_SLEP
),
};
