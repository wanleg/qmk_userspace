...
#define _______________Gherkin_Row_0_______________			KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P
...
//#define _______________GherkinLike_2_______________     TD(TD_SFT_CAPS), SFT_T(KC_Z), KC_X, KC_C, KC_V, LT(ETC, KC_B), KC_N, KC_M, KC_COMM, ALT_T(KC_DOT), CTL_T(KC_BSPC), SFT_T(KC_ENT)
#define _______________GherkinLike_2_______________     KC_LSFT, SFT_T(KC_Z), KC_X, KC_C, KC_V, LT(ETC, KC_B), KC_N, KC_M, KC_COMM, ALT_T(KC_DOT), CTL_T(KC_BSPC), SFT_T(KC_ENT)
#define _______________GherkinLike_3_______________     KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL, NUMBER, ETCETERA, LT(_FN, KC_SPC), DIRECTION, KC_RGUI, KC_RALT, KC_DEL, KC_RCTL
...
#define _______________GherkinLike_3_OneHand_______     KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL, NUMBER, ETCETERA, LT(_FN, KC_SPC), DIRECTION, KC_RGUI, KC_RALT, ONEHAND, KC_RCTL
...
#define _______________Qwerty_Row__2_______________   KC_LSFT,KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, SFT_T(KC_ENT)
...
#define _______________SUBTER_Row__1_______________   KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC
 ...
 * |        | mLeft  | mDown  | mRight |        | SHIFT  | mBtn3  | mBtn1  | mBtn2  |  ;     |  '     |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | Sft//Cp|        |        |        |        | C-A-D  |mScrLeft| mScrRt | ALT    |  DEL   | SLEEP  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        |        |        | C-A-D  |        |        |        |        |        |
 * '-----------------------------------------------------------------------------------------------------------'
 */
...
#define _______________Gherkin_FN_1________________			RGB_M_B, UG_VALD, UG_VALU, UG_TOGG, UG_NEXT, _______, _______, _______, _______, _______
#define _______________Gherkin_FN_2________________			UG_HUED, UG_HUEU, UG_SATD, UG_SATU, _______, _______, _______, _______, _______, QWERTY
